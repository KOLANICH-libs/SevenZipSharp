...
namespace SevenZip
{
	...
	/// <param name="directory">The directory where the files are to be unpacked.</param>
#endif
		public IAsyncResult BeginExtractArchive(string directory
#if !DOTNET20
			, DispatcherPriority eventPriority
#if CS4
				= DispatcherPriority.Normal
			...
			return (new ExtractArchiveDelegate(ExtractArchive)).BeginInvoke(directory, AsyncCallbackImplementation, this);
		}
	...
	/// <param name="stream">The stream where the file is to be unpacked.</param>
#endif
		public IAsyncResult BeginExtractFile(string fileName, Stream stream
#if !DOTNET20
			, DispatcherPriority eventPriority
#if CS4
				= DispatcherPriority.Normal
			...
			return (new ExtractFileByFileNameDelegate(ExtractFile)).BeginInvoke(fileName, stream, AsyncCallbackImplementation,
				this);
		}
	...
	/// <param name="stream">The stream where the file is to be unpacked.</param>
#endif
		public IAsyncResult BeginExtractFile(int index, Stream stream
#if !DOTNET20
			, DispatcherPriority eventPriority
#if CS4
				= DispatcherPriority.Normal
			...
			return (new ExtractFileByIndexDelegate(ExtractFile)).BeginInvoke(index, stream, AsyncCallbackImplementation, this);
		}
	...
	/// <param name="directory">Directory where the files are to be unpacked.</param>
#endif
		public IAsyncResult BeginExtractFiles(string directory
#if !DOTNET20
			, DispatcherPriority eventPriority
#if CS4
				= DispatcherPriority.Normal
			...
			return (new ExtractFiles1Delegate(ExtractFiles)).BeginInvoke(directory, indexes, AsyncCallbackImplementation, this);
		}
	...
	/// <param name="directory">Directory where the files are to be unpacked.</param>
		...
		public IAsyncResult BeginExtractFiles(string directory
			...
			return (new ExtractFiles2Delegate(ExtractFiles)).BeginInvoke(directory, fileNames, AsyncCallbackImplementation, this);
		}
	...
	/// <param name="extractFileCallback">The callback to call for each file in the archive.</param>
#endif
		public IAsyncResult BeginExtractFiles(ExtractFileCallback extractFileCallback
#if !DOTNET20
			, DispatcherPriority eventPriority
#if CS4
				= DispatcherPriority.Normal
			...
			return (new ExtractFiles3Delegate(ExtractFiles)).BeginInvoke(extractFileCallback, AsyncCallbackImplementation, this);
		}
	}
}